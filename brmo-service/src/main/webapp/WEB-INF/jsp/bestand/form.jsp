...
<stripes:layout-render name="/WEB-INF/jsp/layout/default.jsp">
    ...
    <stripes:layout-component name="contents">
        ...
        <h1>KVK Handelsregister vestigingen inladen</h1>
            Om KVK vestigingen in te laden, klik <stripes:link beanclass="nl.b3p.brmo.service.stripes.NHRActionBean">hier</stripes:link>.
        </stripes:form>
